...
This is the prompt template used by `ralph-monitor.sh` for continuous oversight of the implementation process.
...
❌ **NO**:
- Minor code quality issues (let ralph-review-and-fix handle it)
